...
# >python KeyNet2openCV.py -i F:/3DOM/VENTIMIGLIA/SUBMODEL/model_1500x1000/KeyNet/desc/IMG_9001.jpg -g F:/3DOM/VENTIMIGLIA/SUBMODEL/model_1500x1000/imgs_1500x1000/IMG_9001.jpg
...
def KeyNet2openCV(desc_path):

    # Import KeyNet keypoints and descriptors
    kp = np.load(os.path.join('{}.kpt.npy'.format(desc_path)))
    opencv_descriptors = np.load('{}.dsc.npy'.format(desc_path))
    kp_numb = kp.shape[0]
...
def main():
    ...
    opencv_keypoints, opencv_descriptors, kp_numb = KeyNet2openCV(desc_path)
